...
def main():
    ...
    with open(INPUT_GRAPHNAMES, 'r') as f:
    ...
    for input_graph in graphs:
        ...
        for solver_filename in solvers:
            ...
            input_path = os.path.join("inputs", input_graph + ".in")
            ...
            out_file = os.path.join(OUTPUT_DIRECTORY, input_graph[:-3], solver_filename + '.out')
